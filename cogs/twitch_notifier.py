...
class TwitchNotifier(Cog):
    ...
    async def on_member_update(self, before: Member, after: Member):
        ...
        for activity in activities:
            ...
            msg = f"{after.name.mention} が {stream.platform} で配信を始めました！"
            await self.bot.get_channel(constant.CH_TWITCH).send(msg, embed=embed, allowed_mentions=AllowedMentions.none())
