...
CH_LIMITED_MESSAGE_NUMBER = int(os.getenv("CH_LIMITED_MESSAGE_NUMBER", "744439125880602645"))
CH_MAIN = int(os.getenv("CH_MAIN", "608657253725372429"))
CH_STORE_ROLE_DATA = int(os.getenv("CH_STORE_ROLE_DATA", "814158928921362452"))
